...
sim.Send_Joint(jointID = 0, firstObjectID=0, secondObjectID=1,      x=0, y=0,z=upper_ARM_LENGTH+ lower_ARM_RADIUS,    n1=-1, n2=0, n3=0,   lo=-3.14159/2.0, hi=+3.14159/2.0)

sim.Send_Joint(jointID = 1, firstObjectID=0, secondObjectID=2,      x=0, y=0,z= lower_ARM_RADIUS,    n1=0, n2=0, n3=1)
